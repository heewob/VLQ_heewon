...
def makeACfg(sample, year, systematic__, datafile, jec_file_AK4, jec_file_AK8, all_systematics):
   ...
   for systematic in systematic_:
      ...
      for iii, suffix in enumerate(systematicSuffices):
         ...
         if "MC" in sample or "TprimeTprime" in sample:
...
'2018': { 'QCDMC700to1000': 'data/JEC/2017_UL/MC/Summer19UL17_V5_MC_Uncertainty_AK8PFPuppi.txt' ,
   ...
   # signal_files.pkl
   #signal_samples_pkl = open('data/pkl/signal_samples.pkl', 'rb')
   #signal_samples   = pickle.load(signal_samples_pkl)

   #signal_files_pkl = open('data/pkl/signal_datasets.pkl', 'rb')
